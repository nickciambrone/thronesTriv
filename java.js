...
var questions = [
    {
        ...
        video: "<iframe width='560' height='315' class='img-fluid border border-danger' src='https://www.youtube.com/embed/0miGSjYG0G4' frameborder='0' allow='autoplay; encrypted-media'allowfullscreen></iframe>"
    },
    {
        ...
        video: '<iframe width="560" height="315" class="img-fluid border border-danger" src="https://www.youtube.com/embed/jOMa0LeWArE?start=232" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>'
    },
    {
        ...
        video: '<iframe width="560" height="315" class="img-fluid border border-danger" src="https://www.youtube.com/embed/Q4O9IWLoABU?start=54" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>'
    },
    {
        ...
        video: '<iframe width="560" height="315" class="img-fluid border border-danger" src="https://www.youtube.com/embed/KCMM0ir8-EA?start=128" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>'
    },
    {
        ...
        video: '<iframe width="560" height="315" class="img-fluid border border-danger" src="https://www.youtube.com/embed/afzEd-fCWq0?start=165" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>',
    },
    {
        ...
        video: '<iframe width="560" height="315" class="img-fluid border border-danger" src="https://www.youtube.com/embed/Tuf0-ZHsOs8?start=85" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>'
    },
    {
        ...
        video: '<iframe width="560" height="315" class="img-fluid border border-danger" src="https://www.youtube.com/embed/VvtVK3GxoO4?start=124" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>'
    },
    {
        ...
        video: '<iframe width="560" height="315" class="img-fluid border border-danger" src="https://www.youtube.com/embed/qafMsdPLDhM?start=319" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>'
    },
    {
        ...
        video: '<iframe width="560" height="315" class="img-fluid border border-danger" src="https://www.youtube.com/embed/jRQkt2wqaCE" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>'
    },
    {
        ...
        video: '<iframe width="560" height="315" class="img-fluid border border-danger" src="https://www.youtube.com/embed/1ke9iUJykiw?start=178" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>'
    },
    {
        ...
        video: '<iframe width="560" height="315" class="img-fluid border border-danger" src="https://www.youtube.com/embed/0cyEM57UJks" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>'
    },
    {
        ...
        video: '<iframe width="560" height="315" class="img-fluid border border-danger" src="https://www.youtube.com/embed/cKp8_hC6gvI?start=43" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>'
    },
    {
        question: "What does 'Khaleesi' translate to in Dothraki?",
        answers: ["Queen", "Princess", "Wife of Khal", "Mother"],
        correctAnswer: "Wife of Khal",
        video: '<iframe width="560" height="315" class="img-fluid border border-danger" src="https://www.youtube.com/embed/oBFBeGt6Njk" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>'
    },
    {
        question: "Which of the following is not a face of the 7?",
        answers: ["Mother", "Maiden", "Widow", "Crone"],
        correctAnswer: "Widow",
        video: '<iframe width="560" height="315" class="img-fluid border border-danger" src="https://www.youtube.com/embed/yJZm-9nITWQ?start=10" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>'
    },
    {
        ...
        video: '<iframe width="560" height="315" class="img-fluid border border-danger" src="https://www.youtube.com/embed/VM9wWtHozCM?start=90" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>'
    },
    {
        question: "What is the name of Bran's wolf?",
        answers: ["Summer", "Nymeria", "Shaggydog", "Greywind"],
        correctAnswer: "Summer",
        video: '<iframe width="560" height="315" class="img-fluid border border-danger" src="https://www.youtube.com/embed/4nWeC2tmrHw" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>'
    },
    {
        question: "Who saved Tyrion's life in a trial by combat?",
        answers: ["Oberyn", "Jamie", "The Mountain", "Bronn"],
        correctAnswer: "Bronn",
        video: '<iframe width="560" height="315" class="img-fluid border border-danger" src="https://www.youtube.com/embed/NN30YMzja6Y" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>'
    },
    {
        ...
        video: '<iframe width="560" height="315" class="img-fluid border border-danger" src="https://www.youtube.com/embed/bWclAgsyDfU?start=26" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>'
    },
    {
