...
var questions = [
    {
        ...
        video: "<iframe width='560' height='315' src='https://www.youtube.com/embed/0miGSjYG0G4' frameborder='0' allow='autoplay; encrypted-media'allowfullscreen></iframe>"
    },
    {
        ...
        video: '<iframe width="560" height="315" src="https://www.youtube.com/embed/jOMa0LeWArE?start=232" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>'
    },
    {
        ...
        video: '<iframe width="560" height="315" src="https://www.youtube.com/embed/Q4O9IWLoABU?start=54" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>'
    },
    {
        ...
        video: '<iframe width="560" height="315" src="https://www.youtube.com/embed/KCMM0ir8-EA?start=128" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>'
    },
    {
        ...
        video: '<iframe width="560" height="315" src="https://www.youtube.com/embed/afzEd-fCWq0?start=165" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>',
    },
    {
        ...
        video: '<iframe width="560" height="315" src="https://www.youtube.com/embed/Tuf0-ZHsOs8?start=85" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>'
    },
    {
        ...
        video: '<iframe width="560" height="315" src="https://www.youtube.com/embed/VvtVK3GxoO4?start=124" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>'
    },
    {
        ...
        video: '<iframe width="560" height="315" src="https://www.youtube.com/embed/qafMsdPLDhM?start=319" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>'
    },
    {
        ...
        video: '<iframe width="560" height="315" src="https://www.youtube.com/embed/jRQkt2wqaCE" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>'
    },
    {
        ...
        video: '<iframe width="560" height="315" src="https://www.youtube.com/embed/1ke9iUJykiw?start=178" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>'
    },
    {
        ...
        video: '<iframe width="560" height="315" src="https://www.youtube.com/embed/0cyEM57UJks" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>'
    },
    {
        ...
        video: '<iframe width="560" height="315" src="https://www.youtube.com/embed/cKp8_hC6gvI?start=43" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>'
    },
    {
        question: "What does 'Khaleesi' translate to in Dothraki?",
        answers: ["Queen", "Princess", "Wife of Khal", "Mother"],
        correctAnswer: "Wife of Khal",
        video: '<iframe width="560" height="315" src="https://www.youtube.com/embed/oBFBeGt6Njk" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>'
    },
    {
        question: "Which of the following is not a face of the 7?",
        answers: ["Mother", "Maiden", "Widow", "Crone"],
        correctAnswer: "Widow",
        video: '<iframe width="560" height="315" src="https://www.youtube.com/embed/yJZm-9nITWQ?start=10" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>'
    },
    {
        ...
        video: '<iframe width="560" height="315" src="https://www.youtube.com/embed/VM9wWtHozCM?start=90" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>'
    }
...
var game = {
    ...
    loadQuestion: function () {
        ...
        for (var i = 0; i < questions[game.currentQuestion].answers.length; i++) {
            $("#subwrapper").append("<button type='button' class ='answer-button btn btn-outline-dark' id='button-" + i + "' data-name='" + questions[game.currentQuestion].answers[i] + "'>" + questions[game.currentQuestion].answers[i] + "</button>");
    ...
    timeUp: function () {
        ...
        if (game.currentQuestion == questions.length - 1) {
            $("#subwrapper").append("<br><button id='next' type='button' class='btn btn-dark'>Click to view results</button>")
        }
        else { $("#subwrapper").append("<br><button id='next' type='button' class='btn btn-dark'>Next Question</button>") }
        // if (game.currentQuestion == questions.length - 1) {
        //     $(document).on("click", "#next", function () {
        //         game.nextQuestion();
        //     });
    ...
    results: function () {
        ...
        $("#subwrapper").append("<button id='reset' type='button' class='btn btn-dark'> Restart </button>")
    },
    clicked: function (e) {
        clearInterval(timer);
